...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>ngọc cute chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "ngọc cute", HidePremium = false, IntroText = "ngọc cute⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("ngọc cute SCRIPT")
W:AddLabel("Discordngọc cute")
local Section = W:AddSection({
    Name = "Status"
})
...
local locallv = W:AddLabel("Level")
    ...
    local LevelFarmFarm W:AddLabel("Kaitun : ngọc chưa xuất hiện(ngọc sắp xuất hiện)")
            ...
            while wait() do
                pcall(function()
                    if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Urban") then
                        Elite_Hunter_Status:Set("Elite : ✅ ngọc có")	
                    else
                        Elite_Hunter_Status:Set("Elite : ❌ ngọc chưa có")	
                    end
                end)
            end
        end)
